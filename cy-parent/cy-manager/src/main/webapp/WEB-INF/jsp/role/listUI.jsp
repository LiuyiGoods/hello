...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/js/zTree/css/zTreeStyle/metro.css" />
</head>
<body>
...
<script src="${pageContext.request.contextPath}/resources/js/zTree/js/jquery.ztree.all-3.5.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/role/list.js"></script>
</body>
</html>