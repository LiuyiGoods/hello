...
<head>
	...
	<!-- load css -->
	<link rel="stylesheet" type="text/css" href="/cybus/resources/common/layui/css/layui.css" media="all">
	<link rel="stylesheet" type="text/css" href="/cybus/resources/common/global.css" media="all">
	<link rel="stylesheet" type="text/css" href="/cybus/resources/css/adminstyle.css" media="all">
...
<!-- 加载js文件-->                                                                                                                                                                                           
	<script type="text/javascript" src="/cybus/resources/common/layui/layui.js"></script> 
	<script type="text/javascript" src="/cybus/resources/js/larry.js"></script>
	<script type="text/javascript" src="/cybus/resources/js/index.js"></script>
<!-- 锁屏 -->
