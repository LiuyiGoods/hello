package com.cy.manage.service.impl;
...
import com.cy.dao.PermissionMapper;
...
@Service
//@CacheConfig(cacheNames="permission")//设置缓存名称	
public class PermissionServiceImpl extends BaseServiceImpl<Permission>
	...
	@Override
	@Cacheable("getPermissionListByRoleId")
