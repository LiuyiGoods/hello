...
<body>
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form id="save-form" class="form-horizontal" role="form" action="save" method="post">
	...
	<script src="${pageContext.request.contextPath}/resources/js/permission/saveUI.js"></script>
</body>
</html>